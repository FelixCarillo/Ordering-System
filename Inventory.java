public class Inventory {
    ...
    public static Accessories[] getAccessories() {
        Accessories[] accessories = {
            new Accessories(1, "ESY Eyeglass Case", 200.0),
            new Accessories(2, "ESY Eyeglasses Chain", 160.0),
            new Accessories(3, "ESY Eyeglass Anti-Slip", 120.0),
            new Accessories(4, "ESY Eyeglasses Nose Pads", 30.0),
            new Accessories(5, "ESY Microfiber Cleaning Cloth", 100.0),
            new Accessories(6, "ESY Contact Lens Eye Drops", 300.0),
            new Accessories(7, "ESY Contact Lens Case", 200.0),
            new Accessories(8, "ESY Contact Lens Solution", 400.0),
        };
        return accessories;
    }
}
